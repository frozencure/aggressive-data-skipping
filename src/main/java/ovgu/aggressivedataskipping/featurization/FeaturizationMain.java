...
public class FeaturizationMain {
    ...
    public static void main(String...args) throws IOException {
        ...
        QuerySet queries = service
                .augmentQueries("E:\\Documente\\master\\Sem III\\DBSE Project\\aggressive-data-skipping\\test-queries.json");
        FeatureSet featureSet = service.getFrequentItemSets(new HashSet<>(queries.getQueries()), 2);
...
//        service.writeQueriesToFile(featureSet, "aug-test.json");
        RedundantPredicatesRemover remover =
                new RedundantPredicatesRemover(featureSet.getFeatures(), new HashSet<>(queries.getQueries()), 1);
